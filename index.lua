...
-- StarUpdater URLs
local latestCIA = "http://gs2012.xyz/3ds/starupdater/StarUpdater.cia" -- Unofficial URL is: http://gs2012.xyz/3ds/starupdater/StarUpdater.cia
local latestHB = "http://gs2012.xyz/3ds/starupdater/StarUpdater.3dsx" -- Astronaut must replace this with their own URL, as done for other URLs.
